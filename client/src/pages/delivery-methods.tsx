  ...
  return (
    <div className="space-y-4 md:space-y-6 p-4 md:p-6">
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
        <div>
          <h1 className="text-2xl md:text-3xl font-bold">Delivery Methods</h1>
          <p className="text-sm md:text-base text-gray-600 mt-1 md:mt-2">
            Manage delivery options for your customers
          </p>
        </div>
        <Button onClick={handleNew} className="bg-blue-600 hover:bg-blue-700 text-white border border-blue-600 shadow-lg w-full sm:w-auto px-8 py-3 text-lg font-semibold rounded-lg transition-all duration-200 hover:shadow-xl" data-testid="button-add-delivery-method">
